/* 
* File:                         convertLatLong.ino
* Author:                       Chris Veress, MIT License
* Code used in conjuction with: landNavPatrolCapFinal.ino, tempSensor.ino
*
* THIS CODE WAS NOT WRITTEN BY SAMUEL BREWSTER, BUT IS CALLED BY HIS CODE IN HIS LAND NAV PATROL CAP PROJECT.
*
* Used in Dr. Trudgen's ELEE 4230: Sensor's and Transducer's Class.
* Used in Final Project: Land Nav Patrol Cap
* 
* Code imported from https://github.com/walvok/LatLonToUTM/blob/master/latlon_utm.ino 
*/
